...
% Use Bengali font for Bengali characters
...
\hypersetup{
    ...
    linkcolor=black,
    citecolor=black,
    pdftitle={Internship Report of Shakirul Hasan Khan (2017831034)},
}
...
\include{chapters/LetterOfTransmittal}
\include{chapters/LetterOfEndorsement}
...
\include{chapters/2-CompanyProfile.tex}
\include{chapters/3-PersonalExperince.tex}
\include{chapters/4-ProjectInvolvement.tex}
\include{chapters/5-ProfessionalGrowth.tex}
