    %   The project stems from the template for the title page created by Marco Antonio Corallo, whom I thank. Here are some comments to highlight the presence of some packages that were useful to me for the writing of the thesis. Clearly, it all depends on the type of work one wants to perform, which also determines the different needs. While writing, I spent a lot of time on sites and forums trying to fix some formatting issues, but in general Latex was pretty versatile.

% Type of document. Using twoside implies that chapters always start with the first page on the left, possibly leaving a blank page in the previous chapter. If this thing is bothersome, you can remove it.
