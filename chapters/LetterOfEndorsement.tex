...
\begin{center}
    \begin{tabular}{ccc}
    \cline{1-1} \cline{3-3}
    \begin{tabular}[c]{@{}c@{}}\\Shawal Siddique\\ Chief Technical Officer\\ Kaz Software\end{tabular} & & \begin{tabular}[c]{@{}c@{}}\\Md. Hannan Hossain\\ Senior Software Engineer\\ Kaz Software\end{tabular}
    \end{tabular}
\end{center}
