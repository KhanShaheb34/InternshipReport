...
\begin{center}
    \begin{tabular}{ccc}
        \includegraphics[width=0.3\textwidth]{images/Signs/shaon_sign.png} & & \includegraphics[width=0.35\textwidth]{images/Signs/hannan_sign.png} \\
    \cline{1-1} \cline{3-3}
    \begin{tabular}[c]{@{}c@{}}\\Shawal Siddique Shaon\\Chief Technology Officer\\Kaz Software\end{tabular} & & \begin{tabular}[c]{@{}c@{}}\\Md. Hannan Hossain\\Team Lead (Team Artisan)\\Principal Software Engineer\\ Kaz Software\end{tabular}
    \end{tabular}
\end{center}
